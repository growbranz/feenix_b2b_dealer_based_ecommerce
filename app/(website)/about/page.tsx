  ...
  return (
    <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-24 space-y-24">
      ...
      <section className="grid md:grid-cols-2 gap-8">
        <Card className="rounded-2xl border-slate-100 bg-white shadow-[0_4px_24px_-10px_rgba(30,41,59,0.06)] hover:shadow-[0_16px_40px_-18px_rgba(37,99,235,0.12)] hover:-translate-y-0.5 transition-all duration-300">
      ...
      {/* Statistics */}
      <section className="bg-slate-50 -mx-4 px-4 py-16">
        <SectionHeader
          title="Our Impact"
