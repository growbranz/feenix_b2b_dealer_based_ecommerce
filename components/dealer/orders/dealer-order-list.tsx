...
import { mockOrders, OrderStatus, orderStatusOptions, statusColor, paymentColor } from "@/lib/orders/data"
...
export function DealerOrderList() {
  const orders = React.useMemo(() => mockOrders.filter((o) => o.dealer.id === CURRENT_DEALER_ID), [])
