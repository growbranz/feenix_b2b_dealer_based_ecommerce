        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-12 z-10 hidden lg:block">
            <button
              ...
              className="p-3 rounded-full bg-white border-2 border-slate-200 hover:border-blue-600/50 hover:bg-blue-600/10 transition-all shadow-lg hover:shadow-xl"
            >
          ...
          <div className="overflow-hidden">
            <AnimatePresence mode="wait">
              ...
              >
                <div className="bg-white rounded-2xl border-2 border-slate-200 hover:border-blue-600/50 transition-all duration-300 hover:shadow-xl hover:shadow-blue-600/10 p-8 md:p-12">
                  <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                    {/* Avatar */}
                    <div className="flex-shrink-0">
                      <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center text-white text-2xl font-bold font-poppins shadow-lg">
                    ...
                    <div className="flex-1 text-center md:text-left">
                      <Quote className="h-8 w-8 text-blue-600/30 mb-4 mx-auto md:mx-0" />
